...
const Footer = () => {
  const FooterContent = [
    ...
    ["Products", "Stock & fund", "Drag & drop", "Options"],
    ["Support Center", "Contact Us", "System Status", "Areas of Availabilty"],
  ];

  return (
    <footer className="mt-4  bg-blue-600 text-white p-8">
      <div className="flex justify-around gap-4 mb-6 flex-wrap border-b border-white pb-6 flex-col-reverse md:flex-row">
        <div className="flex flex-col gap-2">
          <div className="bg-white w-fit rounded-full">
            <img src={logo} className="w-12 h-auto" />
          </div>
          <p className="text-white">Take your platform to next level</p>
      ...
      <div className="text-center text-white mb-2">© copyright@2025</div>
    </footer>
  );
};
